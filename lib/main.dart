                      ...
                      builder: (context, sharedObservationsOnFirebase){
                        ...
                        return ValueListenableBuilder(
                            ...
                            builder: (context, box, widget2){
                              ...
                              return StreamBuilder<List<Observation>>(
                                stream: userId.isNotEmpty ? firebaseDatabaseService.observationsService.userObservations(userId) : observationsService.emptyObservationsStream,//TODO - aggregate into observations services (see stashes: shared observations attempt 1 and 2)
                                initialData: const[],
